...
async function entrar(){
  ...
  data.email=document.getElementById("email").value;
  data.password=document.getElementById("password").value;
  fetch('https://dd10afea8a444651a7975b97cdbc8a11.vfs.cloud9.us-east-2.amazonaws.com/signin', { 
  headers: {
  'Content-Type': 'application/json',
  'Access-Control-Allow-Origin':'*'
 },
...
fetch('https://dd10afea8a444651a7975b97cdbc8a11.vfs.cloud9.us-east-2.amazonaws.com/auth/google',{ 
headers: {
'Content-Type': 'application/json' ,
'Access-Control-Allow-Origin':'*'},
method: 'GET',
